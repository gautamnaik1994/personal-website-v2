...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The total business value acquired by the driver in a month (negative
        business indicates cancellation/refund or car EMI adjustments)
      </td>
    </tr>
    <tr>
...
<Alert title='NOTE' variant='warning'>
  There are better ways to impute missing values in PySpark, because of time and
  space complexity of KNN algorithm. I just wanted to learn how to use UDFs
  using scikit-learn's functions.
</Alert>
...
<iframe
  src='https://public.tableau.com/views/OLA_Driver_Churn_Analysis/DriverChurnAnalysis?:showVizHome=no&:embed=true'
  frameBorder='0'
  height='800'
...
![Change in business value](image-2.png)
...
![ratings based on month year](image-3.png)
...
![effect of rating based on city](image-4.png)
...
<Alert title='NOTE' variant='info'>
  Streamlit shutdowns the app after some hours of inactivity. Please click on
  button 'wake up' button to restart the app.
</Alert>
