...
<Alert title='NOTE' variant='warning'>
  The goal of this project is to showcase how to use docker and docker-compose
  to build a multi-container application.
</Alert>
...
- You can read more about Time Series collections in MongoDB [documentation](https://www.mongodb.com/products/capabilities/time-series).
...
You can learn more about Docker Compose in [documentation](https://docs.docker.com/compose/).
