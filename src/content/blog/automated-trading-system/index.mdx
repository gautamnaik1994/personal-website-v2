...
```typescript
//create schedule
const tokenGeneratorFnCron = new events.Rule(this, 'TokenGeneratorFnCronRule', {
...
<p className='text-center'>Daily Signals</p>

![Trades](./trades.png)

<p className='text-center'>Daily Trades</p>

![Daily Pnl](./dailypnl.png)

<p className='text-center'>Daily PNL</p>

![Monthly Pnl](./monthlypnl.png)

<p className='text-center'>Monthly PNL</p>

![Analytics](./analysis.png)

<p className='text-center'>Daily Analysis</p>
